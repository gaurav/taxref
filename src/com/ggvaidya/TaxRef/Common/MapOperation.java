...
/**
 * An interface for mapping values from one value to another. This interface
 * can act as the coderef in a Perl `map' call.
 * 
 * @author vaidyagi
 */
public interface MapOperation {
	/**
	 * We'd like to map 'value' to a single 'returned value'.
	 * 
